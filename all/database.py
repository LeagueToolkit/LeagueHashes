...
class 0x22d8a036(0x995ca734):
    ...
    BoolDriver: (Pointer, 0x0, 0x0, 0x7a851cd8)
...
class TftTrovesBannerTable(0xf790270c):
    NameTraKey: (String, 0x0, 0x0, 0x0)
    Children: (List, 0x0, Embed, 0x18599d08)
...
class 0x4fbc08a8():
    ...
    Units: (List2, 0x0, Embed, 0x8129e422)
...
class 0x5d7e30f9(0x411f92df):
    Callback: (Link, 0x0, 0x0, 0x13e3455e)
...
class 0x6972dbb7(TftTrovesBannerReward):
    NameTraKey: (String, 0x0, 0x0, 0x0)
    0x815829ff: (Link, 0x0, 0x0, BaseLoadoutData)
...
class UiElementGroup(0x9e490c6c):
...
class TftTrovesBannerReward(0xf790270c):
    Quantity: (U32, 0x0, 0x0, 0x0)
    Rarity: (U32, 0x0, 0x0, 0x0)
    0x73b81f0e: (String, 0x0, 0x0, 0x0)
...
class VfxEmitterDefinitionData():
    ...
    Linger: (Pointer, 0x0, 0x0, 0x9b19f2b5)
    Importance: (U32, 0x0, 0x0, 0x0)
    ...
    Audio: (Pointer, 0x0, 0x0, 0x8324a97b)
...
class 0xb662e8c6():
    Banners: (List, 0x0, Link, 0xf5e0c308)
...
class CreateNeutralCamp(0xe3c4beb7):
...
class 0xbdae6d1e(TftTrovesBannerReward):
...
class 0xccb4aa8a():
    ...
    DefaultSet: (Pointer, 0x0, 0x0, 0xa0ce6603)
...
class 0xf5e0c308():
    ...
    NameTraKey: (String, 0x0, 0x0, 0x0)
    0xa187ee92: (String, 0x0, 0x0, 0x0)
    0xb545cd5f: (Link, 0x0, 0x0, TftTrovesBannerTable)
    DescriptionTraKey: (String, 0x0, 0x0, 0x0)
    0xd41db073: (String, 0x0, 0x0, 0x0)
...
class 0xfdc62fbc(TftTrovesBannerReward):
    CurrencyId: (String, 0x0, 0x0, 0x0)
    NameTraKey: (String, 0x0, 0x0, 0x0)
